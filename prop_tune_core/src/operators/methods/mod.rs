...
mod test_procs {
    ...
    #[test]
    fn test_demorg() {
        let input = vec![Proposition::new_not(Proposition::new_or("A", "A"))];
        let expected = vec![Proposition::new_and(
    ...
    fn test_normal() {
        let cases = vec![
            (
                ...
                Proposition::new_or(
                    Proposition::new_and("A", "B"),
                    Proposition::new_and("A", Proposition::new_not("C")),
                ),
            ),
            (
                Proposition::new_and(
                    "A",
                    Proposition::new_or("B", Proposition::new_not(Proposition::new_and("C", "D"))),
                ),
                Proposition::new_or(
                    Proposition::new_and("A", "B"),
                    Proposition::new_or(
            ...
            (
                ...
                Proposition::new_or(
                    ...
                    Proposition::new_or(
                        ...
                        Proposition::new_or(
                            Proposition::new_and("C", "B"),
                            Proposition::new_and("C", "D"),
                        ),
                    ),
                ),
            ),
            ...
            (
                ...
                Proposition::new_not(Proposition::new_implies(
                    Proposition::new_or("A", "B"),
                    Proposition::new_or(Proposition::new_and("C", "D"), "E"),
                )),
                Proposition::new_or(
                    Proposition::new_and(
    ...
    fn test_simplify() {
        ...
        cases
            .into_iter()
            .for_each(|(input, expected)| assert_eq!(expected, input.simplify()));
    }
}
